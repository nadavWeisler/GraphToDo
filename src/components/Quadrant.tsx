...
interface QuadrantProps {
  ...
  onAddTask: (quadrantId: string, text: string, dueDate: string | null, dueTime: string | null) => TaskActionResult
  onToggleTask: (quadrantId: string, taskId: string) => void
  onDeleteTask: (quadrantId: string, taskId: string) => void
  onEditTask: (quadrantId: string, taskId: string, text: string, dueDate: string | null, dueTime: string | null) => TaskActionResult
  onMoveTask: (sourceQuadrantId: string, taskId: string, targetQuadrantId: string) => TaskActionResult
}
